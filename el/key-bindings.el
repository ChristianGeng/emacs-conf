...
(global-set-key (kbd "C-<f11>") 'elpy-shell-send-statement-and-step)
...
;; ;; File finding
;; ausmachen wenn ido nicht geladen wird:
;;(global-set-key (kbd "C-x C-f") 'ido-find-file-maybe-at-point)
